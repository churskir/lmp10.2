...
test:
	...
	./aprox -s spl2 -p test/dane.2.5.7 -g myplot2 -f 2 -t 5 -n 300
	./aprox -s spl3 -p test/dane.3.0.5 -g myplot3 -f 1 -t 5.7 -n 500
	./aprox -s spl4 -p test/dane.4.-9.10 -g myplot4 -f -9 -t 9 -n 10
	./aprox -s spl5 -p test/dane.5.0.1 -g myplot5 -f -1 -t 2 -n 100
	./aprox -s spl6 -p test/dane.6.1.11 -g myplot6 -f 1.1 -t 11.1 -n 150
